...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let centerView1Controller: BaseAnimationController = BaseAnimationController()
        let rightViewController: RightViewController = RightViewController()

        let revealViewController: SWRevealViewController = SWRevealViewController.init(rearViewController: leftViewController, frontViewController: centerView1Controller)
